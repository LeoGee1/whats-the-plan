...
type BarDataItem = { day: string; value: number };
...
//   const [barData, setBarData] = useState<BarDataItem[]>([]);
//   const [pieData, setPieData] = useState<PieDataItem[]>([]);
//   // CONDITION STATE: Simulate authentication status
//   const [isAuthenticated, setIsAuthenticated] = useState<boolean>(true); // Start as authenticated
...
//   const CurrentLayout = isAuthenticated ? MainLayout : AuthLayout;

//   return (
//     // Render the determined layout component
//     <CurrentLayout>
//       <div className="p-6 bg-gray-900 text-white min-h-screen">
//         {/* Toggle Button for Demonstration */}
//         <button
//           onClick={() => setIsAuthenticated(!isAuthenticated)}
//           className="mb-6 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md transition duration-200"
//         >
//           Toggle Authentication (Currently: {isAuthenticated ? 'Authenticated' : 'Not Authenticated'})
//         </button>

//         {/* Dashboard Content - only show if authenticated for realistic behavior */}
//         {isAuthenticated ? (
//           <>
//             <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-6">
//               {[...Array(4)].map((_, i) => (
...
//             <h2 className="text-2xl font-bold">Please log in to view the Dashboard.</h2>
//             {/* You'd typically have a login form or redirect here */}
//           </div>
//         )}
//       </div>
//     </CurrentLayout>
